...
export function useForecast() {
  ...
  const generateSyntheticData = useCallback(({ consumoMensual, volatilidad, leadTime }) => {
    const predicciones = [];
    ...
    // Calcular Safety Stock: (consumo diario) * lead time
    const consumoDiario = consumoMensual / 30;
    const safetyStock = consumoDiario * leadTime;
