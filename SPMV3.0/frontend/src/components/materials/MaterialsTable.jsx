    ...
    <div className="overflow-x-auto border border-[var(--border)] rounded-lg">
      <table className="w-full text-sm" role="table">
        <thead className="bg-[var(--bg-soft)] backdrop-blur-sm border-b-2 border-[var(--border)]">
          <tr>
            <th className="px-4 py-3 align-middle text-center text-xs font-semibold uppercase tracking-wider text-[var(--fg-muted)] border-r border-b border-slate-200">
            ...
            <th className="px-4 py-3 align-middle text-center text-xs font-semibold uppercase tracking-wider text-[var(--fg-muted)] border-r border-b border-slate-200 w-20">
            ...
            <th className="px-4 py-3 align-middle text-center text-xs font-semibold uppercase tracking-wider text-[var(--fg-muted)] border-r border-b border-slate-200 w-12">
              {t('materials_col_nota', 'Nota')}
            </th>
            <th className="px-4 py-3 align-middle text-center text-xs font-semibold uppercase tracking-wider text-[var(--fg-muted)] w-12">
            </th>
          </tr>
        </thead>
        <tbody>
          ...
          {items.map((it, idx) => {
            ...
            return (
              <tr
                ...
                `}
              >
                <td className="px-4 py-3 align-middle font-mono font-semibold text-[var(--fg-strong)]">
                  {it.codigo}
                </td>
                <td className="px-4 py-3 align-middle text-[var(--fg)]">{it.descripcion}</td>
                <td className="px-4 py-3 align-middle text-center text-[var(--fg-muted)]">
                  {it.unidad || '-'}
                </td>
                ...
                <td className="px-4 py-3 align-middle text-right font-mono text-[var(--fg)]">
                  {formatCurrency(it.precio_unitario || 0)}
                </td>
                <td className="px-4 py-3 align-middle text-right font-mono font-semibold text-[var(--fg-strong)]">
