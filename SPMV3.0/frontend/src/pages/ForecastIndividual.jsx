...
const ForecastIndividual = () => {
  ...
  return (
    <Container maxWidth={false} sx={{ py: 2, px: "75px" }}>
      ...
      {/* Aviso de parámetros modificados */}
      {parametrosModificados && (
        ...
        >
          Los parámetros han cambiado. Haz clic en "Analizar" o "Re-analizar" para actualizar el gráfico con el nuevo horizonte de {diasPrediccion} días.
        </Alert>
      )}
      ...
      {forecastData && (
        <>
          {/* Info del material */}
          <Paper elevation={0} sx={{ p: 2, mb: 3, border: "1px solid #dce0e6", borderRadius: 2 }}>
            <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <Box>
                <Typography variant="h6" fontWeight={600} color="#1f1f20">
            ...
            {activeTab === 0 && (
              <>
                ...
                <Suspense fallback={<Skeleton variant="rectangular" height={400} sx={{ borderRadius: 2, mb: 2 }} />}>
                  <Paper elevation={0} sx={{ p: 2, mb: 2, border: "1px solid #dce0e6", borderRadius: 2 }}>
                    <ForecastChart
            ...
            {activeTab === 1 && (
              <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                ...
                <Paper elevation={0} sx={{ p: 3, border: "1px solid #dce0e6", borderRadius: 2 }}>
                  <Typography variant="subtitle1" fontWeight={600} color="#1f1f20" gutterBottom>
      ...
      {!forecastData && !loading && (
        <Paper elevation={0} sx={{ p: 8, border: "1px solid #dce0e6", borderRadius: 2, textAlign: "center" }}>
          <BarChartIcon sx={{ fontSize: 64, color: "#dce0e6", mb: 2 }} />
