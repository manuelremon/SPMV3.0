...
export default function AdminAlmacenes() {
  ...
  return (
    <AdminCrudTemplate
      ...
      fields={[
        { name: 'codigo', label: t("admin_codigo", "Código"), required: true, placeholder: 'Ej: 0001' },
        { name: 'nombre', label: t("admin_nombre", "Nombre"), placeholder: 'Nombre descriptivo del almacén' },
